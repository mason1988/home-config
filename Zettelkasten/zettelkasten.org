...
- Was spricht gegen direkte Lösung (35)
*** header
...
[[test][file:~/Zettelkasten/zettelkasten.org::test]]
(b)
...
Sei \(h(a,b) := \begin{cases} 1 - \frac{a+1-b}{(a+1)-b} &\mbox{(falls } \mbox{a gerade)} \\ \mbox{nicht definiert} &\mbox{(sonst)} \end{cases}\)
#+END_SRC
*** Aufgabe 36
X_1 - X_2
#+BEGIN: aufgabe36
