...
variable 0-stellige Regeln:
    $\frac{\bigv_xA}{\bar{\bigw_xA}} = \frac{\bigv_xA}{\not \bigw_x \not A}, \fr{\bar{\bigw_xA}}{\bigv_xA}$
$\iota: X \mapsto \tau =  (\mathcal{Y}_0 \cup X)^y$ Terme 
$\fr{\bv_x A}{\bar{\bw_x}{\bar{A}}}$,$\fr{\bar{\bw_x\bar{A}}}{\bv_xA}, \fr{\bw_x A}{\iota_x^{\tau}\circ A}$
...
\section{Aufgabe 38}
$$ A = p_3x_0s_2x_1x_4x_3, \g = \i^{s_3x_0x_1x_5|x_3}_{x_3|x_4} $$ \\
\subsection{a)}
...
\subsection{d)}
$$ \gamma_0 \circ \w_{x_4}A = \g \circ \w_{x_4}p_3x_0s_2x_1x_4x_3 = \i^{s_3x_0x_1x_4 | x_2}_{x_3|x_4} \w_{x_4}p_3x_0s_2x_1x_4x_3 $$ \\
$$ \W_{x_2} \i^{s_3x_0x_1x_4 | x_2}_{x_3 | x_4}p_3x_0s_2x_1x_4x_3 = \W_x{_2} p_3x_0s_2x_1x_2s_3x_0x_1x_4 $$
\section{Aufgabe 39}
$$ \g = \i^{x_2 | x_2|x_4}{x_0|x_1|x_2} \; A = p_2s_2x_1x_0x_2, B = p_3x_0x_1x_2 $$ \\
\subsection{a)}
...
** Tutorium
- Aufgabe 40
   $\gamma = \i^{t_0|s^{\tilde}_2x_4x_4}_{x_0 | x_1}$
   2 Fälle: 
   $x_0 \in |t_0|$
   $x_0 \not \in |t_0|$  
...
- Aufgabe 41
  $(\a^{\v}\circ \g)^{\w}$ Hier benutzen: 
   $\A u \in U ( \a^{\v} \circ \gamma)^u_x \us{|A|}{=} \a^{\v \; u}_{x^{|A|}_{\g}} \circ \g_x^{x_{\g}^{|A|}}$
