...
- C-ö f     :: display file
- C-ö r/n   :: next/prev Empty Line
- C-{/}     :: next/prev regex
- C-ö t     :: org tree to indirect buffer
- C-ä n     :: Neues Snippet
- C-ä t     :: Snippet Buffer laden
- C-ä f     :: neues Snippet aus Content
- C-ä h     :: Platzhalter erstellen (für Oneshot Snippet)
- C-ä g     :: Oneshot Snippet (erstellen oder einsetzen)
