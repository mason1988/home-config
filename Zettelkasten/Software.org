...
* Projekte
** TODO Kleinkram
*** DONE das system wiederfinden, mit der man eine sicht auf 2 Buffer verteilen konnte
    - State "DONE"       from "NEXT"       [2013-02-03 So 23:45]
  [[file:~/Zettelkasten/softwaretechnik.org::*a.][a.]]
  Entered on [2013-01-25 Fr 18:42]
*** NEXT emacs-server ohne fenster starten und danach laufen lassen
...
*** DONE pdf in firefox automatisch starten lassen (siehe da wo auch protocol eingestellt wurde)
    - State "DONE"       from "NEXT"       [2013-02-05 Di 10:43]
*** TODO google pentadactyl yank to clipboard
*** NEXT firefox schließen, wenn der letzte tab geschlossen wurde
...
*** CANCELLED Möglichkeiten prüfen um informationen/texte einem konkreten Header zuzuordnen :CANCELLED:
    - State "CANCELLED"  from "NEXT"       [2013-02-03 So 23:46] \\
      jetzt gibts nen besseren latex modus
*** DONE my-make-latex-2 zusammenstellen
    - State "DONE"       from "TODO"       [2013-02-06 Mi 10:59]
**** bisheriger beispielcode
(defun blatest () (interactive)
  (let (ov)
    (setq ov (make-overlay 20 30))
    (overlay-put ov 'display (create-image "~/test.png"))))
*** CANCELLED Möglichkeiten sammeln, zum zeilenweisen auslesen und splitten bei trennzeichene :CANCELLED:
    - State "CANCELLED"  from "TODO"       [2013-02-06 Mi 10:59]
*** CANCELLED beim link erstellen eben jene information in extra ast unterbringen :CANCELLED:
    - State "CANCELLED"  from "TODO"       [2013-02-06 Mi 10:59]
*** CANCELLED 2. löschenroutine, welche nach dem löschen eben diesen wert wieder ausliest :CANCELLED:
    - State "CANCELLED"  from "TODO"       [2013-02-06 Mi 10:59]
*** NEXT bilder im org - mode in separaten Ordner verschieben
...
*** DONE der transparente bereich auf den draufgemappt wird (python) auf mindestgröße setzen
    - State "DONE"       from "NEXT"       [2013-02-06 Mi 10:59]
...
*** NEXT playlists ganz allgemein planen
...
*** NEXT capture um aktuelle firefox seite an to read zu senden
...
** TODO Shortcuts						    :PROJECT:
   ...
   :END:
*** NEXT welche (ya)snippets machen noch Sinn? -> einbauen
...
*** DONE markierung und/oder anzeige für evil marks im Dokument anzeige ;goggle
    - State "DONE"       from "NEXT"       [2013-02-03 So 23:52]
...
*** NEXT Shortcuts für next / prev buffer setzen
...
*** DONE Suchmaschine für Quellcodes
    - State "DONE"       from "NEXT"       [2013-02-03 So 23:52]
*** NEXT alternative rc.lua suchen
...
*** DONE google awesome wm borders
    - State "DONE"       from "TODO"       [2013-02-04 Mo 11:07]
...
** TODO eshell							    :PROJECT:
   - State "TODO"       from "DONE"       [2013-02-06 Mi 11:00]
...
*** NEXT google Symlink / alias eshell
** DONE Tags							    :PROJECT:
   - State "DONE"       from "TODO"       [2013-02-06 Mi 11:00]
*** DONE etags installieren
*** DONE google: wie können tags zu den unterschiedlichen dokumentarten generiert werden
    - State "DONE"       from "NEXT"       [2013-02-03 So 23:45]
*** DONE google: welche navigations und sammelmöglichkeiten gibt es?
    - State "DONE"       from "TODO"       [2013-02-03 So 23:54]
*** DONE Shortcuts für die Tags entsprechend legen
    - State "DONE"       from "TODO"       [2013-02-03 So 23:54]
* copy and paste
(yank in emacs = paste)
...
- falls noch nicht vorhanden:
  - launchpad Seite oder sowas suchen
  - sudo vim /etc/apt/sources.list
  - irgend eine Version oben bei Launchpad auswählen und kopieren (deb ...)
  - bei vim pasten (mittlere maustaste)
  - speichern
  - sudo apt-get update
sudo apt-get --fixbroken install   (installiert abhängigkeit, deinstalliert fehlerhaftes)
sudo apt-get remove paketname   (entfernt paket)
sudo apt-get purge paketname   (entfernt paket inkl config)
** wlan
wicd-ncurses um netzwerk zu konfigurieren
** tastatur
- modifier belegen:
  xmodmap -e 'clear mod1'
  xmodmap -e 'keycode 94 = Control R' <= unterstrich fehlt
  xmodmap -e 'add control = Control R' <= unterstrich fehlt
- keycode anzeigen lassen:
  xev
** standby
...
sudo modprobe snd-mixer-oss
  notwendig, bevor aumixer gestartet werden kann
  - volume um lautstärke zu steuern
    => aumixer muss installiert sein und funktionieren
* synergy
** keyboardlayout
...
* Emacs
** nützliche Befehle
global-auto-revert-mode    macht genau das
...
*** tag - file benutzen
M-x visit-tags-table um tag datei zu öffnen
...
** 32 bit force
   ...
   winetricks
** sachen installieren
deinstalliere wine applikation =>  installieren
* install/make kram
1. ./configure
2. make
3. sudo make install
* zathura
  config findet in $XDG_CONFIG_HOME/zathura/zathurarc statt
  $XDG_CONFIG_HOME = ~/.config   nach standard
** generell option setzen
set optionname value
** tastenkombi setzen
map [mode] tasten funktion [parameter]
A = Alt; C = Control; S = Shift
<A-a> z.B.
modes: normal, visual, insert, index

=> navigationskommandos bekommen z.B. noch eine extra variable 
   in welche richtung
*** shortcut funktionen
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-0.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-1.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-2.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-3.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-4.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-5.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-6.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-7.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-8.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-9.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-10.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-11.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-12.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-13.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-14.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-15.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-16.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-17.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-18.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162604_24545WA-19.png]]

*** parameter
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-0.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-1.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-2.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-3.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-4.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-5.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-6.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-7.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-8.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-9.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-10.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-11.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-12.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-13.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-14.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-15.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-16.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-17.png]]
[[/home/florian/Zettelkasten/Software.org_20130211_162643_2454GhG-18.png]]
*** Beispiel für angepasste scroll tasten
map <C-n> scroll half-down
map <C-r> scroll half-up

* Firefox
** hints
:set hintkeys='abcdefg'    um hintkeys zu setzen
:highlight -a Hint text-transform:uppercase;      zeigt hints in großbuchstaben, reagiert aber auf kleinbuchstaben
** allgemeines
:help bla     für hilfe
:dialog preferences      ruft dialoge auf
b  um buffer anhand namen oder nummer zu wählen
:tabde  dettach tab
:taba   attach tab
** umgang mit "komplexen" seiten
Ctrl+z => pass through => native shortcuts können benutzt werden
   z.b. google-reader und da dann picture up/down
   siehe auch passkeys option, für dauerhafte einstellung bestimmter Seiten
ZI  hardcore zoom (sogar videos usw.)
zz   zoom normal zustand
** pentadactyl plugins
*** installieren
...
** flash reparieren
*** verlust von fullscreen bei monitorwechsel
- eine variable in der flashinstallation muss zerstört werden
#+BEGIN_SRC shell
sudo apt-get install ghex
sudo uptadedb
locate libflashplayer.so #nach /usr/lib und mozilla ausschau halten
gksu ghex /pfad/libflashplayer.so
#+END_SRC
- dann auf suche und im rechten kasten "_NET_ACTIVE_WINDOW" suchen
- dort dann im rechten fenster irgendwo in die variable reinklicken und was
  verändern, zB das N am anfang zu A
- alles restarten
...
Alternativ Suchmaschiene installieren(firefox addon) und dann :dialog searchengines
...
oder mit Y kopieren und in emacs dann mit "*p pasten
* Shell
...
*** modale shortcuts
=> es existieren modi die aktiviert werden und die unterschiedlichen modi interpretieren die tasten dann jeweils anders
    => die modi entsprechen keygrabbern (ziehen sich alle gedrückten tasten)
**** keygrabber mode
     muss hinter das snippet für den eigentlichen modi
#+BEGIN_SRC lua
...
#+END_SRC
**** keys für nen mode
    Tasten können direkt als variablen benutzt werden, die mit den funktionen überlagert werden 
#+BEGIN_SRC lua
...
** elisp
*** TODO durch regex resultate iterieren
*** TODO bestimmte Linie im code farblich hervorheben
*** TODO usereingabe abfragen
*** TODO erzwinge ansicht, also split-windows, find-files und resize-windows
*** interaktive funktion starten

*** my-make-latex2
**** overlay erstellen
     #+begin_src elisp
     (let (ov) (setq ov (make-overlay 20 30)) (overlay-put ov 'display (create-image "~/test.png")))
     #+end_src
**** overlay löschen
     #+begin_src elisp
     (remove-overlays start end prop value) ;alles optional, prop und value sind filter
     #+end_src
**** find overlay
     #+begin_src elisp
     (overlays-at (point)) ; alles was (point) berührt
     (overlays-in start end) ; alles was start-end berührt
     (next-overlay-change pos) ; nächstes overlay ab pos
     #+end_src
**** overlays traversieren
     #+begin_src elisp
     ;nur vorhandensein von overlays prüfen
     (let (ovs) (setq ovs overlays-at (point)) (if (not (car ovs)) (message "noch kein overlay hier")))
     ;oder: richtig traversieren
     (while ovs (let ((ov (car ovs)))
                (overlay-get ov attr) ;was auch immer man auslesen möchte
                (setq ovs (cdr ovs))))
     #+end_src
**** globale variablen
gesondert mit (defvar var-name) anmelden
(defcustom ...) wäre der befehl für abgespeicherte variablen, die über das customize menü erreichbar sind
**** allgemeines
    /tmp dient als ordner für tempoäre daten, da gibts auch direkt Schreibzugriff, gelöscht wird bei reboot
*** listen in elisp
Listen sind wie bei Schema, also '(a b c) ist die liste a,b,c
(car '(a b c)) ist gleich a und (car '()) = nil
(cdr '(a b c)) ist '(b c)
Traversion läuft also ober eine variable die die liste entgegennimmt, ersten werd auslesen und dann auf '(b c) setzen
   while prüft dann einfach nur die variable
*** replace in String
...
** Suchmaschinen
- https://github.com/
- http://code.google.com/intl/de/ (sucht vorrangig nach projekten)
- http://code.ohloh.net/ (ehemals koders)
* Shortcutliste
** einfache Tasten
- AltGr - ü :: Escape
- AltGr - ö :: Tab
