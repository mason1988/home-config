...
globalkeys = awful.util.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.util.spawn_with_shell("emacsclient -c") end),
...
--- custom keys ende
    ...
    -- Prompt
    awful.key({ modkey },            "v",     function () mypromptbox[mouse.screen]:run() end),
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = 4, -- CHANGED beautiful.border_width,
...
client.add_signal("focus", function(c) c.border_color = "red" end) -- CHANGED beautiful.border_focus end)
client.add_signal("unfocus", function(c) c.border_color = beautiful.border_normal end)
-- }}}

------ neue modifikation, koennte fuer probleme sorgen
