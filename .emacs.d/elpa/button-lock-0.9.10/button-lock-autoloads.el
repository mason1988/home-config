...
Toggle Button-Lock mode in every possible buffer.
With prefix ARG, turn Global-Button-Lock mode on if and only if
ARG is positive.
...
;;;***

;;;### (autoloads nil nil ("button-lock-pkg.el") (20675 18669 88772))
