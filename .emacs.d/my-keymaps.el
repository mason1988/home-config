...
(global-set-key (kbd "M-e") 'keyboard-quit)
...
(define-key minibuffer-local-ns-map "\M-e" 'keyboard-quit)
(define-key minibuffer-local-completion-map "\M-e" 'keyboard-quit)
(define-key minibuffer-local-must-match-map "\M-e" 'keyboard-quit)
(define-key minibuffer-local-isearch-map "\M-e" 'keyboard-quit)
